// Forgejo mirror of .releaserc.js. Identical release rules and notes, but publishes
// via @saithodev/semantic-release-gitea (the Gitea/Forgejo API) instead of
// @semantic-release/github. Consumed only by .forgejo/actions/semantic-release-monorepo,
// so .releaserc.js stays the frozen GitHub config.
